...
window.addEventListener('DOMContentLoaded', function () {
  ...
  feedSlider.init();
  var player1 = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_2__["default"]('.showup .play', '.overlay');
  player1.init();
  new _modules_difference__WEBPACK_IMPORTED_MODULE_0__["default"]('.officerold', '.officernew', '.officer__card-item').init();
  new _modules_forms__WEBPACK_IMPORTED_MODULE_1__["default"]('form').init();
});
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function createPlayer(url) {
      this.player = new YT.Player(this.iframeBlockID, {
        ...
        events: {
          'onReady': this.onPlayerReady // 'onStateChange': onPlayerStateChange
