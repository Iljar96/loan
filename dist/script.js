...
window.addEventListener('DOMContentLoaded', function () {
  ...
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_4__["default"]('.module__video .play', '.overlay').init();
  ...
  new _modules_accordeon__WEBPACK_IMPORTED_MODULE_0__["default"]('.module__info-show').init();
...
/*#__PURE__*/
function () {
  function Accordeon(triggerSelector) {
  ...
  _createClass(Accordeon, [{
        ...
        this.triggers.forEach(function (btn) {
          btn.addEventListener('click', function (e) {
            if (btn.nextElementSibling) {
              _this._slideToggle(btn.nextElementSibling);
            }
          });
        });
      }
    ...
    key: "_slideToggle",
    value: function _slideToggle(target) {
      var duration = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 500;
...
function () {
  ...
  _createClass(Difference, [{
    ...
    value: function bindTriggers(officer, items, counter) {
      var btn = officer.querySelector('.plus');
    ...
    value: function init() {
      ...
      this.btns.forEach(function (btn) {
        return btn.addEventListener('click', function () {
          return _this.downloadItem(_this.path);
        });
      });
    }
  }]);
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindCloseBtn() {
      ...
      this.close.addEventListener('click', function (e) {
        _this.overlay.classList.remove('fadeIn');

        _this.overlay.classList.add('fadeOut');

        _this.player.stopVideo(); // this.player.destroy();


        setTimeout(function () {
          _this.overlay.classList.remove('fadeIn', 'show');
        }, 1000);
      });
    }
  }, {
        ...
        btn.addEventListener('click', function (e) {
          if (!btn.closest('.module__video-item') || btn.closest('.module__video-item').getAttribute('data-disabled') !== 'true') {
            ...
            if (document.querySelector('iframe#frame')) {
              ...
              _this2.overlay.classList.add('animated', 'fadeIn', 'show');

              if (_this2.path !== btn.dataset.url) {
                _this2.path = btn.dataset.url;
      ...
      try {
        if (n === 3) {
          if (!this.hanson.classList.contains('showed')) {
            setTimeout(function () {
              _this.hanson.classList.add('animated', 'slideInUp', 'showed');

              _this.hanson.style.display = '';
            }, 3000);
          } else {
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn) {
        ...
        btn.parentNode.previousElementSibling.addEventListener('click', function (e) {
          ...
          e.preventDefault(); //Перемещение к указанному слайду
...
function (_Slider) {
  ...
  function MiniSlider(container, prev, next, activeClass, autoplay) {
    var _this;

    _classCallCheck(this, MiniSlider);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, prev, next, activeClass, autoplay));
  ...
  _createClass(MiniSlider, [{
    ...
    value: function decorizeSlides() {
      ...
      this.slides.forEach(function (slide) {
        return slide.classList.remove(_this2.activeClass);
      });
    ...
    value: function init() {
      ...
      try {
        ...
        this.container.addEventListener('mouseover', function (e) {
          return clearInterval(_this5.autoPlayInterval);
        });
        this.container.addEventListener('mouseout', function (e) {
          return _this5.startAutoSlide();
        });
      } catch (e) {}
    }
  }]);
